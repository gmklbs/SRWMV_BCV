var ENGINE_SETTINGS = {
	...
	DISABLE_FULL_BATTLE_SCENE: true,// if true the option to show the battle DEMO will not be available
	BATTLE_SCENE: {
		FXAA_ON: false,
		SPRITE_WORLD_SIZE: 3,
	...
	ATTRIBUTE_MODS: {
		"limited": [
			{type: "cannot_recharge", modType: "addFlat", value: 1}
		],
			},
	ATTRIBUTE_DISPLAY_NAMES: {
		"limited": {name: "Limited", effects: ["Weapon cannot be resupplied"]}
	},
